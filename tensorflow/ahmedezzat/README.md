# Custom network by Ahmed Ezzat using mobilenet like depthwise convolutions stacking.
...
cd ~/workspace/ncappzoo/tensorflow/ahmedezzat/
...
Compile the network based on already existing frozen model
~~~
make compile
~~~
